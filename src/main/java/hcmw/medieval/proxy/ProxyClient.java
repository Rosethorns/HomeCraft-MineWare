...
public class ProxyClient extends ProxyCommon {
    ...
    public void registerRenderers() {
        ...
        hcmw.core.proxy.ProxyClient.tileEntityRenderers.put(HCMWMedieval.MOD_ID + ":bed", new TileEntityObjRenderer(new RenderInfo(new ResourceLocation("hcmw:medieval/model/pbed.obj")).setRenderPasses(3).setResourceLocs(new ArrayList<ResourceLocation>() {{
